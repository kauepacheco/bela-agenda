...
export default async function BookingPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const business = await prisma.business.findUnique({ where: { slug }, include: { services: { where: { active: true, professionals: { some: { professional: { active: true } } } }, include: { professionals: { where: { professional: { active: true } }, include: { professional: true } } }, orderBy: { name: "asc" } } } });
