...
export default async function Dashboard() {
  ...
  return <AppShell context={context}>
    ...
    <section className="metric-grid">
      ...
      <article className="metric-card"><div className="metric-icon green"><CircleDollarSign/></div><div className="metric-value">{money(week.reduce((total, item) => total + item.priceCents, 0))}</div><div className="metric-label">Valor previsto na semana</div><span className="trend neutral">{week.length} atendimentos · valores registrados</span></article>
